<?php
namespace carlonicora\minimalism\modules\jsonapi\abstracts;
...
abstract class abstractJsonApiController implements controllerInterface {
    /** @var string */
    ...
    /** @var abstractJsonApiModel */
    protected abstractJsonApiModel $model;
